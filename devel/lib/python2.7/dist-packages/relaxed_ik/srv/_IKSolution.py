...
"""autogenerated by genpy from relaxed_ik/IKSolutionRequest.msg. Do not edit."""
import sys
...
import relaxed_ik.msg
import std_msgs.msg

class IKSolutionRequest(genpy.Message):
  _md5sum = "5c994d3a5365dd2924fa4ed43357ff6a"
  _type = "relaxed_ik/IKSolutionRequest"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """relaxed_ik/EEPoseGoals ee_pose_goals
...
uint32 stride  # stride of given dimension"""
  ...
  _slot_types = ['relaxed_ik/EEPoseGoals','relaxed_ik/JointAngles','float64','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.ee_pose_goals is None:
        self.ee_pose_goals = relaxed_ik.msg.EEPoseGoals()
      if self.init is None:
        self.init = relaxed_ik.msg.JointAngles()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.init.angles.data))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.ee_pose_goals.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.init.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      self.init.angles.data = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 16
...
def _get_struct_4d():
    ...
    return _struct_4d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from relaxed_ik/IKSolutionResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class IKSolutionResponse(genpy.Message):
  ...
  _type = "relaxed_ik/IKSolutionResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """relaxed_ik/JointAngles joint_angles
bool success
...
uint32 stride  # stride of given dimension"""
  ...
  _slot_types = ['relaxed_ik/JointAngles','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.joint_angles is None:
        self.joint_angles = relaxed_ik.msg.JointAngles()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.joint_angles.angles.data))
      _x = self.success
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.joint_angles.angles.data = struct.unpack(pattern, str[start:end])
      start = end
      end += 1
